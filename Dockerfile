...
FROM registry.access.redhat.com/ubi9/ubi-minimal:9.8-1789546276 AS downloader
...
FROM registry.access.redhat.com/ubi9/ubi:9.8-1789552280 AS packages
...
FROM registry.access.redhat.com/ubi9/ubi-minimal:9.8-1789546276 AS final
